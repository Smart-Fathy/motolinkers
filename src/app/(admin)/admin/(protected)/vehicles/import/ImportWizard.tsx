...
export default function ImportWizard({
  ...
  // The autohome flow returns the same {variantColumns, specRows} shape
  // the CSV importer produces, so we route straight into the existing
  // mapping step — same row-by-row dropdowns, same per-variant
  // skip/create/update decision, same applyImport at the end.
